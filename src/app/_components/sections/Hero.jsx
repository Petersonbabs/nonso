                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="sb-ilustration-fix">
                            <div className="sb-illustration-1-2">
                                <div className="sb-food-1">
                                <img src="/img/illustrations/pounded-yam.png" alt="food" className=" w-full" />
                                </div>
                                <div className="sb-food-2 rotate-45">
                                <img src="/img/illustrations/jollof-rice.png" alt="food" className="w-full " />
                                </div>
                                <div className="sb-food-3">
                                <img src="/img/illustrations/salad.png" alt="food" className="w-full" />
                                </div>
